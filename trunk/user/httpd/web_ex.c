...
ej_firmware_caps_hook(int eid, webs_t wp, int argc, char **argv) 
{
	...
	int has_btn_mode = 0;
#endif
#if defined (USE_WID_5G) && (USE_WID_5G==7610 || USE_WID_5G==7612 || USE_WID_5G==7615 || USE_WID_5G==7915) && BOARD_HAS_5G_11AC
	int has_5g_vht = 1;
#else
	int has_5g_vht = 0;
#endif
#if defined (USE_WID_5G) && (USE_WID_5G==7615 || USE_WID_5G==7915) && BOARD_HAS_5G_11AC
	int has_5g_mumimo = 1;
	int has_5g_txbf = 1;
